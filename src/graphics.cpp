...
void Graphics::drawSprite(const SpriteData &spriteData, COLOR_ARGB color) {
	...
	D3DXVECTOR2 spriteCenter = D3DXVECTOR2((float)(spriteData.width / 2 * spriteData.scale.x),
		(float)(spriteData.height / 2 * spriteData.scale.y));
